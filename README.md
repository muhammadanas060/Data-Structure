# Data-Structure
This repository is designed to help you learn Data Structures and Algorithms in a simple and structured way. Each topic is explained with examples, code, and clear logic to make learning easy for beginners.

# Index
🟢 BEGINNER LEVEL (Foundational Algorithms)
Basic Sorting (Start Here)
...
Count set bits (basic loop)
XOR properties (swap numbers)
...
Find single number (XOR variants)
...
🟣 EXPERT LEVEL (Optional for FAANG)
...
Convex hull trick
Li Chao tree
Alien's trick (binary search on DP)
Meet in the middle
